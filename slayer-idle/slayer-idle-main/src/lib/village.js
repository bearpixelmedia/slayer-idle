...
export const VILLAGE_BUILDINGS = [
  {
    ...
    name: "Town Hall",
    icon: "🏛️",
    spriteStation: { url: "/sprites/environment/stations/workbench.png", w: 192, h: 352, tileW: 32, tileH: 32, col: 0, row: 0 },
  ...
  },
  {
    ...
    name: "Forge",
    icon: "🔨",
    spriteStation: { url: "/sprites/environment/stations/anvil.png", w: 272, h: 160, tileW: 32, tileH: 32, col: 0, row: 0 },
  ...
  },
  {
    ...
    name: "Sanctum",
    icon: "⛪",
    spriteStation: { url: "/sprites/environment/stations/bonfire.png", w: 64, h: 384, tileW: 32, tileH: 32, col: 0, row: 0 },
  ...
  },
  {
    ...
    name: "Market",
    icon: "🏪",
    spriteStation: { url: "/sprites/environment/stations/workbench.png", w: 192, h: 352, tileW: 32, tileH: 32, col: 1, row: 0 },
  ...
  },
  {
    ...
    name: "Barracks",
    icon: "⚔️",
    spriteStation: { url: "/sprites/environment/stations/furnace.png", w: 192, h: 384, tileW: 32, tileH: 32, col: 0, row: 0 },
