  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden", background: "linear-gradient(to bottom, #0a1628, #1e3a5f, #1a4a2e)" }}>
      ...
      {layer(4, 0.28, 33, 30, 0.65,
        <SpriteTileRow spriteUrl={sprites.treeFar} tileWidth={42} count={45} fallback={
          <div style={{ display: "flex", width: "200%", height: "100%", alignItems: "flex-end" }}>
      ...
      {layer(7, 0.57, 29, 43, 0.88,
        <SpriteTileRow spriteUrl={sprites.treeMidFront} tileWidth={70} count={32} fallback={
          <div style={{ display: "flex", width: "200%", height: "100%", alignItems: "flex-end" }}>
      ...
      {layer(8, 0.65, 27, 48, 0.9,
        <SpriteTileRow spriteUrl={sprites.treeFront} tileWidth={75} count={45} fallback={
          <div style={{ display: "flex", width: "200%", height: "100%", alignItems: "flex-end" }}>
            {Array.from({ length: 45 }).map((_, i) => (
      ...
      {layer(9, 0.84, 62, 22, 0.82,
        sprites.shrubBack ? <SpriteTileRow spriteUrl={sprites.shrubBack} tileWidth={40} count={60} /> :
