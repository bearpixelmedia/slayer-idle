...
export default function ParallaxBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden">
      {/* Sky gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-sky-700 via-sky-500 to-sky-400" />
      ...
      <div className="absolute top-1/4 left-0 right-0 h-1/3 animate-ground-scroll" style={{ animationDuration: "80s", opacity: 0.4 }}>
      ...
      <div className="absolute top-1/3 left-0 right-0 h-2/5 animate-ground-scroll" style={{ animationDuration: "40s", opacity: 0.65 }}>
        <div className="flex whitespace-nowrap w-[200%] h-full items-end">
      ...
      <div className="absolute bottom-40 left-0 right-0 h-1/2 animate-ground-scroll" style={{ animationDuration: "20s", opacity: 0.9 }}>
        <div className="flex whitespace-nowrap w-[200%] h-full items-end">
          {Array.from({ length: 30 }).map((_, i) => (
            <svg
              key={`fore-mountain-${i}`}
      ...
      {/* Foliage/trees left side - fastest parallax */}
      <div className="absolute bottom-32 left-0 right-0 h-32 animate-ground-scroll" style={{ animationDuration: "12s", opacity: 1 }}>
        <div className="flex whitespace-nowrap w-[200%] h-full items-end gap-2">
          {Array.from({ length: 35 }).map((_, i) => (
            ...
            >
              ...
              {/* Tree trunk */}
              <div className="w-2 h-12 bg-amber-900" />
            </div>
          ))}
        </div>
      </div>

      {/* Bushes and low foliage - very fast parallax */}
      <div className="absolute bottom-24 left-0 right-0 h-16 animate-ground-scroll" style={{ animationDuration: "8s", opacity: 1 }}>
      ...
      {/* Ground layer */}
      <div className="absolute bottom-20 left-0 right-0 h-20 bg-gradient-to-b from-green-900 via-green-950 to-yellow-900" />

      {/* Ground detail texture */}
      <div className="absolute bottom-20 left-0 right-0 h-20 animate-ground-scroll" style={{ animationDuration: "6s" }}>
