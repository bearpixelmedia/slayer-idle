...
export default function PrestigePanel({ canPrestige, soulsOnPrestige, slayerPointsOnPrestige, currentSouls, onPrestige }) {
  ...
  return (
    <div className={`p-2 rounded-lg bg-gradient-to-r from-accent/20 to-purple-900/20 ${HUD_THEME.panel.border}`}>
                ...
                <AlertDialogDescription className="text-muted-foreground space-y-3">
                  ...
                  <div className="pt-2 border-t border-border/30">
                    <p className="text-[10px] text-muted-foreground/80">
                      <span className="text-foreground font-semibold">Why prestige?</span> Unlock powerful skills, multiply your earnings by {Math.floor((currentSouls + soulsOnPrestige) * 5)}%, and break through cost walls with fresh upgrades.
                    </p>
                  </div>
                  <div className="pt-2">
