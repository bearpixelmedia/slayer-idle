...
export default function StatsBar({ state, tapDamage, idleCPS, className }) {
  ...
  return (
    <div className={className || "fixed top-2 left-2 right-2 z-20 flex flex-wrap items-center justify-between gap-2 px-3 py-2 bg-card/80 backdrop-blur-md rounded-lg border border-border"}>
